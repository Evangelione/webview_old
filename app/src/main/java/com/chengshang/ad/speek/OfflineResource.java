...
public class OfflineResource {
    ...
    public static final String VOICE_FEMALE = "F";//标准女声

    public static final String VOICE_MALE = "M";//标准男声


    public static final String VOICE_DUYY = "Y";//情感儿童声

    public static final String VOICE_DUXY = "X";//情感男声
