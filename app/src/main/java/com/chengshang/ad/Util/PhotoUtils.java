package com.chengshang.ad.Util;
...
public class PhotoUtils {
    ...
    public static void takePicture(Activity activity, Uri imageUri, int requestCode) {
        openPic(activity,imageUri,requestCode);
    }
     ...
     */
    public static void openPic(Activity activity,Uri imageUri, int requestCode) {
